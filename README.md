# CS50x Programming Assignments

This repository contains my solutions to CS50x problem sets (Weeks 1-4).
...
- **CS50 Library** (get_string, get_int, etc.)
- **File I/O** (BMP manipulation, WAV processing)
- **Memory Management** (malloc, free)
- **Algorithms** (Luhn, Greedy, Sort, Search)

## 🚀 How to Run

```bash
# Clone the repository
git clone https://github.com/Introduction-to-Programming-2026-IBU/introduction-to-programming-assignment-1-erinda7I.git
cd introduction-to-programming-assignment-1-erinda7I

# Compile an exercise
clang -o pset1/hello/hello pset1/hello/hello.c -lcs50
